...
namespace CarsRent.LIB.Model
{
    public class Human : IBaseModel
    {
        ...
        [StringLength(30, MinimumLength = 1, ErrorMessage = "Длина имени не должна быть меньше 1 символа и превышать 20 символов.")]
        public string Name { get; set; }
        [Required(ErrorMessage = "Вы не ввели фамилию")]
        [StringLength(30, MinimumLength = 1, ErrorMessage = "Длина фамилии не должна быть меньше 1 символа и превышать 20 символов.")]
        public string Surname { get; set; }
        [Required(ErrorMessage = "Вы не ввели отчество")]
        [StringLength(30, MinimumLength = 1, ErrorMessage = "Длина отчества не должна быть меньше 1 символа и превышать 20 символов.")]
