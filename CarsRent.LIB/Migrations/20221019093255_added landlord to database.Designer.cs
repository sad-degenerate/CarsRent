...
namespace CarsRent.LIB.Migrations
{
    ...
    [Migration("20221019093255_added landlord to database")]
    partial class addedlandlordtodatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarsRent.LIB.Model.LandlordInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LandlordInfos");
                });

            modelBuilder.Entity("CarsRent.LIB.Model.RenterInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarsRent.LIB.Model.Car", b =>
                {
                    b.HasOne("CarsRent.LIB.Model.LandlordInfo", "Landlord")
                        .WithMany("OwnedCars")
            ...
            modelBuilder.Entity("CarsRent.LIB.Model.LandlordInfo", b =>
                {
                    b.HasOne("CarsRent.LIB.Model.Human", "Landlord")
                        .WithMany("LandlordInfos")
                        .HasForeignKey("LandlordId");
            ...
            modelBuilder.Entity("CarsRent.LIB.Model.Human", b =>
                {
                    ...
                    b.Navigation("LandlordInfos");

                    b.Navigation("RenterInfos");
                });
